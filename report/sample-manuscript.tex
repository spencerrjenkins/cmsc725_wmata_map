...
\begin{tabular}{lccc}
\toprule
\textbf{Network} & \textbf{College Park → DCA} & \textbf{Bethesda → Travilah} & \textbf{Congress Heights → Silver Spring} \\
\midrule
DC Metro Trip Planner & 43 min & No route found & 41 min \\
Naive & 32 min & 32 min & 17 min \\
Naive + Iterations & 37 min & 1 hr 1 min & 19 min \\
