...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{img/area_considered.png}
    \caption{Counties and districts considered as part of the Washington, DC metropolitan area.}
    \label{fig:area_considered}
\end{figure}

As shown in Figure~\ref{fig:area_considered}, the study area includes all counties and districts listed in Table~\ref{tab:counties}.

% --- Figure: Real-World Transit Network ---
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{img/wmata.png}
    \caption{Map of the real-world WMATA transit network in the Washington, DC region.}
    \label{fig:wmata}
\end{figure}

Figure~\ref{fig:wmata} provides a reference for the existing transit network, which is compared to the generated networks throughout this study.

% --- Figure: Census Block Map ---
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{img/city_map.png}
    \caption{Census block map for the Washington, DC area.}
    \label{fig:city_map}
\end{figure}

Figure~\ref{fig:city_map} shows the census block boundaries used for population and density analysis.

% --- Figure: Transformed Census Block Data ---
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{img/point_likelihood.png}
    \caption{Transformed census block data representing input to the recursive spatial algorithm.}
    \label{fig:point_likelihood}
\end{figure}

Figure~\ref{fig:point_likelihood} visualizes the transformed census block data used to identify high-need locations for transit.

% --- Figure: KDE Heatmap ---
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{img/kde.png}
...
Figure~\ref{fig:kde_heatmap} displays the KDE heatmap used to model spatial demand for transit.
...
Figure~\ref{fig:contracted_gabriel} shows the contracted Gabriel graph used as the basis for candidate network construction.
...
Figure~\ref{fig:voronoi} illustrates the Voronoi polygons used to analyze neighborhood coverage and spatial equity.
