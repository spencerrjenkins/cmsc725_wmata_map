...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{./img/wmata.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{./img/area_considered.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{./img/city_map.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{./img/point_likelihood.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{./img/kde.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{./img/graph.png}
...
\noindent\textbf{Access the Transit Network Viewer:} \href{https://spencerrjenkins.github.io/cmsc725_wmata_map/app}{spencerrjenkins.github.io/cmsc725_wmata_map/app}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./img/itin_1_gen.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./img/itin_1_gen_details.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./app/gen.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./app/iter.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{./app/naive.png}
